...
public class WrapperClassTester {
	...
	public static void main(String[] args) {
		...
		int i2 = integer.intValue();// unwrapping primitive data int from
									// wrapper object
		Integer integer2 = new Integer("23");// all wrapper class except
		System.out.println(integer2);		 // Character can take String in
											 // argument
